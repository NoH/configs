...
(defun color-theme-blackboard ()
  ...
  (color-theme-install
   '(color-theme-blackboard
     ...
     (gui-element ((t (:background "#D4D0C8" :foreground "F8F8F8"))))
     (region ((t (:background "#253B76"))))
     (mode-line ((t (:background "black" :foreground "#61CE3C"))))
     (mode-line-inactive ((t (:background "#090909" :foreground "grey"))))
     ...
     (zmacs-region ((t (:background "snow" :foreground "#F8F8F8")))))))
