...
-- Looks --
-- bar
customPP = defaultPP { ppCurrent = xmobarColor "DarkOrange" ""
                     , ppHidden = xmobarColor "Aquamarine" ""
                     , ppHiddenNoWindows = xmobarColor "Aquamarine" ""
                     , ppUrgent = xmobarColor "#FFFFAF" "" . wrap "[" "]"
                     , ppLayout = xmobarColor "#FF6400" ""
                     , ppTitle = xmobarColor "#F8F8F8" "" . shorten 80
                     , ppSep = xmobarColor "#61CE3C" "" " | "
                     }
